        ...
        <div className="flex flex-col justify-center bg-white/10 backdrop-blur-md p-6 sm:p-8 rounded-lg shadow-lg border border-white/20 w-full max-w-sm sm:max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 ">
            ...
            <div className="form-control pt-2">
              <label className="label cursor-pointer flex items-center gap-2 text-white text-sm">
                <input
                  type="checkbox"
                  name="agreeToTerms"
                ...
                />
                <span>
                  I agree to the <a href="#" className="underline hover:text-purple-200 transition-colors">Terms</a> and <a href="#" className="underline hover:text-purple-200 transition-colors">Privacy Policy</a>
                </span>
              </label>
            </div>
            <button
